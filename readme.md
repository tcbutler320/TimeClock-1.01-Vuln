...
- [TimeClock Software 1.01 Authenticated Time-Based SQL Injection](#timeclock-software-101-authenticated-time-based-sql-injection-1)
- [Overview](#overview-1)
  - [About Authors](#about-authors-1)
  - [Navigating the Report](#navigating-the-report-1)
  - [About Timeclock](#about-timeclock-1)
  - [About the Vulnerability](#about-the-vulnerability-1)
- [Testing the POC](#testing-the-poc-1)
  - [Requirements](#requirements-1)
  - [Test Against Our Server](#test-against-our-server-1)
  - [Remote Testing](#remote-testing-1)
  - [Local Testing](#local-testing-1)
- [Running Docker on Remote Server](#running-docker-on-remote-server-1)
- [Creating Docker App from Source](#creating-docker-app-from-source-1)
- [Exploit Details](#exploit-details-1)
...
Upon executionThe application will hang for the sleep time. When it finisheds, you will notice a "1" in the notes feild. This indicates that the user was found. Should you test with a different username, you will notice a "0", indicating that no user was found.     
...
The image below shows a manual test of the PoC, where the username 'fred' is being tested. As you can see below, the response of "1" means the user was found.
